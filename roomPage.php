...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <a href="FacultyPage.php" ><li>Faculty</li></a>
            <a href="roomPage.php" class="active"><li>Rooms</li></a>
...
//            }
       ...
       $arrday=array();
        if($result->num_rows>0){
            ...
            echo " <h3><span style='color:white; font-size:1.2em'>Room No: </span>$roomno</h3>                    <h3><span style='color:white; font-size:1.2em'>Day:</span> $day</h3>
